    ...
    <div ref={containerRef} className="space-y-4">
      ...
      {!isManualMode && (
        <div className="relative">
          <Label htmlFor="addressSearch">{t('fields.street')}</Label>
          <div className="relative mt-1">
            <Input
              id="addressSearch"
              value={searchQuery}
              onChange={(e) => handleSearchChange(e.target.value)}
              placeholder={tAddress('searchPlaceholder')}
              disabled={disabled}
              className="pr-10"
            />
      ...
      {isManualMode && (
        <>
          <div>
            <Label htmlFor="manualStreet">{t('fields.street')}</Label>
            <Input
              id="manualStreet"
              value={manualStreet}
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div>
              <Label htmlFor="manualSuburb">{t('fields.suburb')}</Label>
              <Input
                id="manualSuburb"
                value={manualSuburb}
            ...
            <div>
              <Label htmlFor="manualState">{t('fields.state')}</Label>
              <select
                id="manualState"
            ...
            <div>
              <Label htmlFor="manualPostcode">{t('fields.postcode')}</Label>
              <Input
                id="manualPostcode"
                maxLength={4}
